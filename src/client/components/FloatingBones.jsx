...
// Inline SVG paw prints (teal, blue, indigo) — no external assets required
const PAW_TEAL =
  ...
  const options = useMemo(
    () => ({
      ...
      interactivity: {
        ...
        modes: {
          grab: { distance: 140, links: { opacity: 0.25, color: '#0d9488' } },
          bubble: { distance: 160, size: 24, duration: 0.4, opacity: 0.85 },
          push: { quantity: 2 },
        },
      },
      particles: {
